...
\$routes->group('{$this->module_lower}', static function (\$routes) {
    \$routes->get('', [{$this->module}Controller::class, 'index']);
    \$routes->get('create', [{$this->module}Controller::class, 'create']);
    \$routes->post('onCreate/(:any)', [{$this->module}Controller::class, 'onCreate']);
    \$routes->get('update/(:any)', [{$this->module}Controller::class, 'update']);
    \$routes->post('onUpdate/(:any)', [{$this->module}Controller::class, 'onUpdate']);
    \$routes->delete('onDelete', [{$this->module}Controller::class, 'onDelete']);
    \$routes->get('detail/(:any)', [{$this->module}Controller::class, 'show']);
});
";
...
/**
 * replace code in Routes.php with this code
